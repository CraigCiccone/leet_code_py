...
# instead you will be given access to the node to be deleted directly. It is guaranteed that the node to be deleted is
# not a tail node in the list.
#
# Example 1:
#
...
if __name__ == "__main__":
    ...
    solution.deleteNode(list1.next.next)
